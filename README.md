...
This directory contains files generated during the binary trees lesson of the ALX Software
Engineering programme. The files contain functions that create, travers and edit binary trees.

The following files are included:

- binary_trees.h: contains the prototypes of all functions created, as well as the structs used to create nodes
